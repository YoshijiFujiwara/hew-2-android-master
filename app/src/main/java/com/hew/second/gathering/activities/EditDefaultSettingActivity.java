...
public class EditDefaultSettingActivity extends BaseActivity {
    ...
    private void fetchList() {
        ...
        dialog.show();
        ApiService service = Util.getService();
        Observable<DefaultSettingDetail> token = service.getDefaultSettingDetail(defaultSettingId);
        cd.add(token.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(
    ...
    public void saveDefaultSettingName() {
        ...
        dialog.show();
        ApiService service = Util.getService();
        Observable<DefaultSettingDetail> token = service.updateDefaultSettingName(defaultSettingId, body);
        cd.add(token.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(
