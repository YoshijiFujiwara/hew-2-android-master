...
public class GuestSessionFragment extends BaseFragment {
    ...
    public static GuestSessionFragment newInstance() {
        return new GuestSessionFragment();
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = activity.findViewById(R.id.swipeLayout_guest_session);
        // 色設定
        ...
        listView.setEmptyView(activity.findViewById(R.id.emptyView_guest_session));
